...
gff_grp1 = rtracklayer::import.gff3(opt$a)
gff_grp2 = rtracklayer::import.gff3(opt$b)
...
write.table(tx_metadata, file.path(opt$o, "reviseAnnotations.transcript_metadata.txt"), sep = "\t", quote = FALSE, row.names = FALSE)
...
rtracklayer::export.gff3(grp_1_upstream_gff, file.path(opt$o, "reviseAnnotations.grp_1_upstream.gff3"))
rtracklayer::export.gff3(grp_1_downstream_gff, file.path(opt$o, "reviseAnnotations.grp_1_downstream.gff3"))
rtracklayer::export.gff3(grp_1_contained_gff, file.path(opt$o, "reviseAnnotations.grp_1_contained.gff3"))
...
#Export different events
rtracklayer::export.gff3(grp_2_upstream_gff, file.path(opt$o, "reviseAnnotations.grp_2_upstream.gff3"))
rtracklayer::export.gff3(grp_2_downstream_gff, file.path(opt$o, "reviseAnnotations.grp_2_downstream.gff3"))
rtracklayer::export.gff3(grp_2_contained_gff, file.path(opt$o, "reviseAnnotations.grp_2_contained.gff3"))
