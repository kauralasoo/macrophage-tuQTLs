...
transcript_data = tbl_df(readRDS("../../annotations/GRCh37/genes/Ensembl_90/Homo_sapiens.GRCh37.90.transcript_data.rds"))
refseq_data = tbl_df(readRDS("../../annotations/GRCh37/genes/Ensembl_90/Homo_sapiens.GRCh37.90.refseq_data.rds"))
transcript_tags = read.table("../../annotations/GRCh37/genes/Ensembl_90/Homo_sapiens.GRCh37.87.transcript_tags.txt", stringsAsFactors = FALSE)
...
saveRDS(tbl_df(tags_df), "../../annotations/GRCh37/genes/Ensembl_90/Homo_sapiens.GRCh37.87.tags_dataframe.rds")

#Add transcript tags into the data.frame
tags_df = readRDS("../../annotations/GRCh37/genes/Ensembl_90/Homo_sapiens.GRCh37.87.tags_dataframe.rds")
...
saveRDS(filtered_data, "../../annotations/GRCh37/genes/Ensembl_90/Homo_sapiens.GRCh37.90.compiled_tx_metadata.filtered.rds")  

#For each gene mark the transcripts with longest starts and ends
marked_data = markLongestTranscripts(filtered_data)
saveRDS(marked_data, "../../annotations/GRCh37/genes/Ensembl_90/Homo_sapiens.GRCh37.90.compiled_tx_metadata.longest_marked.rds")  
