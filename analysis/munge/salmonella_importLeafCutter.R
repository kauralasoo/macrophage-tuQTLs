...
intron_counts = read.table("processed/salmonella/leafcutter/leafcutter_perind_numers.counts.gz")[,sample_names]
...
saveRDS(se, "results/SummarizedExperiments/salmonella_leafcutter_counts.rds")
...
leafcutter_ranges = dplyr::transmute(tbl_df(intron_meta_final), transcript_id, chr, transcript_start, 
  ...
  GRangesList()
saveRDS(leafcutter_ranges, "results/annotations/salmonella_leafcutter.GRangesList.rds")
