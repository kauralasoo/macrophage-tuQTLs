...
count_matrix = loadCounts("processed/acLDL/featureCounts/", design_matrix$sample_id, sub_dir = FALSE, counts_suffix = ".featureCounts.txt")
...
saveRDS(se, "results/SummarizedExperiments/acLDL_featureCounts.rds")
