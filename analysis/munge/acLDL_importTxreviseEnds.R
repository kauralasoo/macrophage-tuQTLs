...
tx_abundances = list('txrevise.grp_1_ends' = readRDS("processed/acLDL/matrices/txrevise.grp_1_ends.salmon_txrevise.rds"),
                     'txrevise.grp_2_ends' = readRDS("processed/acLDL/matrices/txrevise.grp_2_ends.salmon_txrevise.rds"))
...
saveRDS(se, "results/SummarizedExperiments/acLDL_salmon_txrevise_ends.rds")
