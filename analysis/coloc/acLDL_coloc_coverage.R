...
#acldl_list = readRDS("results/SummarizedExperiments/acLDL_salmon_gene_abundances.rds")
...
trqtl_min_pvalues = readRDS("results/trQTLs/acLDL_trQTL_min_pvalues.rds")[1:3]
...
revised_granges = readRDS("results/reviseAnnotations/reviseAnnotations.GRangesList.rds") %>%
  purrr::flatten()
leafcutter_granges = readRDS("results//acLDL_leafcutter.GRangesList.rds")
